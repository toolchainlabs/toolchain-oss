...
resource "aws_ses_domain_identity" "toolchain_com" {
  domain = "toolchain.com"
}

resource "aws_ses_email_identity" "noreply" {
  email = "noreply@toolchain.com"
}

resource "aws_ses_email_identity" "webmaster" {
  email = "webmaster@toolchain.com"
}
