...
class BuildAndDeployToolchainSPAProd(ToolchainBinary):
    BUCKET = "assets.us-east-1.toolchain.com"
    CF_DIST_TAGS = {"toolchain_env": "production", "toolchain_app_name": "prod-frontend"}
    ...
    def __init__(self, cmd_args: Namespace) -> None:
        ...
        self._installer = BuildAndDeployToolchainSPA.create(
            aws_region=cmd_args.aws_region,
            bucket=self.BUCKET,
            base_key="prod/frontend",
    ...
    def _get_lock(self) -> DeploymentLock:
        return DeploymentLock.for_deploy("frontend_spa", self._deployer)
...
if __name__ == "__main__":
    BuildAndDeployToolchainSPAProd.start()
