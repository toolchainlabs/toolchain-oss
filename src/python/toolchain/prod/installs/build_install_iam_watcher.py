...
class BuildAndDeployIamWatcher(ToolchainBinary):
    _PEX_TARGET = "src/python/toolchain/prod/iam_watcher:iam_keys_watcher"
    _CHART_PATH = Path("prod/helm/devops/iam-keys-watcher/")
    ...
    def run(self) -> int:
        ...
        release = f"{namespace}-iam-keys-watcher"
...
if __name__ == "__main__":
    BuildAndDeployIamWatcher.start()
