...
from toolchain.django.site.views.well_known import get_well_known_urls
...
urlpatterns.extend(get_well_known_urls())
...
_SETTINGS = dict(ROOT_URLCONF=__name__, SECRETS_READER=secrets_accessor_factories.test_secrets_reader())
